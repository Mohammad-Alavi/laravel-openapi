...
describe('HeaderReference', function (): void {
    it('can be created with a valid token', function (): void {
        ...
        expect($headerReference->toString())->toBe('header.Content-Type');
    });
    ...
    it('can be created with a token containing special characters', function (): void {
        ...
        expect($headerReference->toString())->toBe('header.X-Custom-Header!#$%&\'*+-.^_`|~');
    });

    it('throws an exception for an empty token', function (): void {
        expect(fn (): HeaderReference => HeaderReference::create(''))->toThrow(
    ...
    it('throws an exception for a token with invalid characters', function (): void {
        expect(fn (): HeaderReference => HeaderReference::create('Invalid@Header'))->toThrow(
            InvalidArgumentException::class,
