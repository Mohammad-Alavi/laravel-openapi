...
namespace MohammadAlavi\ObjectOrientedOpenAPI\Support\RuntimeExpression\Request;

use MohammadAlavi\ObjectOrientedOpenAPI\Support\RuntimeExpression\RequestExpression;
...
final readonly class RequestBodyExpression extends RequestExpression
{
    ...
    public static function create(string $value = ''): self
    {
        ...
        if (filled($value) && !str_starts_with($value, '/')) {
            $value = '/' . $value;
        }
